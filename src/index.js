                    ...
                    <div className="mainBox">
                        ...
                        <div className="socialBox">
                            ...
                            <a href="https://www.linkedin.com/in/erikryverling">
                                <svg className="socialLogo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <a href="https://medium.com/@erik.r.yverling">
                                <svg className="socialLogo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                                    <desc>Medium logo</desc>
                ...
                <div className="lowerSectionMain">
                    <div className="lowerContentBox">
                        ...
                        <div className="articlesBox">
                            ...
                            <a href="https://medium.com/@erik.r.yverling/unit-testing-ui-state-in-android-viewmodels-b19973311900">
                                <img src="./waterfall.png" alt="waterfall"/>
                                <h4>Unit Testing UI State in Android ViewModels</h4>
                        ...
                        <div className="projectsBox">
                            ...
                            <a href="https://www.github.com/erikryverling/wearto">
                                <img src="./wearto-logo.png" alt="WearTo logo"/>
                                <h3>WearTo</h3>
                                <p>
                            ...
                            <a href="https://www.soundcloud.com/megoemusic">
                                <img src="./megoe-logo.png" alt="Megoe logo"/>
                                <h3>DJ mixes</h3>
                                <p>
